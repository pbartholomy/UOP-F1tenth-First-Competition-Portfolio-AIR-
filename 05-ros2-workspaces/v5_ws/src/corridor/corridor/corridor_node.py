...
# ── TUNING ────────────────────────────────────────────────────
DRIVE_DUTY        = 0.075   # cruise speed
MAX_DUTY          = 0.120   # PI controller ceiling (hard cap on duty output)
START_BOOST_DUTY  = 0.088   # kick from standstill
...
ERPM_FULL        = 34000   # cruise (replaces DRIVE_DUTY)
ERPM_MODERATE    = 28000   # 85% zone
ERPM_CORNER_PRE  = 25000   # 80% zone (pre-corner slowdown)
ERPM_CORNER_FAST = 26000   # sweeping/wide corner (front dist near CORNER_MM)
ERPM_CORNER_TIGHT= 18000   # hairpin (front dist near ESTOP_MM)
ERPM_SLOW        = 16000   # tight slow zone
ERPM_CRAWL       = 12000   # near-stop crawl
