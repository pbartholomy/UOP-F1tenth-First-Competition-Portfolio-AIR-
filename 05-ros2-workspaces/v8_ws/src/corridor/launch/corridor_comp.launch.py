...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package="corridor", executable="corridor_node_comp",     name="corridor_node",     output="screen"),
        ...
        # COMP: tuned ZED node (QUALITY depth + confidence + coverage gate)
        Node(package="corridor", executable="zed_obstacle_node_comp", name="zed_obstacle_node", output="screen",
             condition=IfCondition(LaunchConfiguration("viz"))),
    ])
